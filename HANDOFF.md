...
| ---------------------------------- | ------ | -------------------------- |
| `screenshots/dark/`                | 17     | Тёмная тема, скелетоны     |
| `screenshots/light/`               | 17     | Светлая тема, скелетоны    |
| `screenshots/loaded/dark/`         | 13     | Тёмная с данными, desktop  |
| `screenshots/loaded/light/`        | 13     | Светлая с данными, desktop |
| `screenshots/mobile/dark/`         | 13     | Тёмная мобила, скелетоны   |
| `screenshots/mobile/light/`        | 9      | Светлая мобила, скелетоны  |
| `screenshots/mobile/loaded/dark/`  | 13     | Тёмная мобила, с данными   |
| `screenshots/mobile/loaded/light/` | 13     | Светлая мобила, с данными  |

> Viewport: desktop 1440×900, mobile 390×844 (iPhone 14 Pro). Скелетоны — 2 сек после load, данные — 8-10 сек.

### Дизайн-аудит — план анализа (3 фазы)

**Фаза 1 — Инвентаризация**: `design-consultant` (GPT-4o multimodal-looker) на все 4 набора → structured findings per screen + cross-screen inconsistencies.
...
- 🔄 Фаза 1: ожидает запуска после проверки мобильных скриншотов
- ⬜ Фаза 2-3: после Фазы 1
